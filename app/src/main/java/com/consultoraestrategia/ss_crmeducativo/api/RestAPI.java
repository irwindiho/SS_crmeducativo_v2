...
public class RestAPI {
    ...
    //asd
//    private final String urlString = "http://CCIEV/PortalMovil/PortalAcadMovil.ashx";
    private final String urlString = "http://192.168.0.151/PortalMovil/PortalAcadMovil.ashx";
    ...
    public String load(String contents) throws IOException {
