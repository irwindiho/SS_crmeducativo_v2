...
public class ListaTareaCursoAdapter extends RecyclerView.Adapter<ListaTareaCursoAdapter.ViewHolder> {
    ...
    // Constructor
    public ListaTareaCursoAdapter(ArrayList<Tarea> tareaArrayList, MainCursosDocenteActivity activity) {
