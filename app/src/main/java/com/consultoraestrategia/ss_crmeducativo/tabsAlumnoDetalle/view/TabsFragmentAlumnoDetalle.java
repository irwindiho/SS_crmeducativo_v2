package com.consultoraestrategia.ss_crmeducativo.tabsAlumnoDetalle.view;
...
import com.consultoraestrategia.ss_crmeducativo.tabsAlumnoDetalle.view.adapters.PagerAlumnoAdapter;
...
public class TabsFragmentAlumnoDetalle extends DialogFragment {
    ...
    public static TabsFragmentAlumnoDetalle newInstance() {
        TabsFragmentAlumnoDetalle fragment = new TabsFragmentAlumnoDetalle();
        return fragment;
    }
